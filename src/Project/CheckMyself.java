...
public class CheckMyself extends javax.swing.JFrame {

	private userMessage user = null;
    public CheckMyself(userMessage user) {
    	this.user = user;
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel10, jLabel11, jLabel12, jLabel13, jLabel14, jLabel15, jLabel2, jLabel9});
        ...
        if(user.getSex()==1) jLabel9.setText("男");
        				else jLabel9.setText("女");
        jLabel10.setText(user.getAccnumber()+"");
        jLabel11.setText(user.getAge()+"");
        jLabel12.setText(user.getBiraddress());
        jLabel13.setText(user.getAddress());
        jLabel14.setText(user.getEmail());
        jLabel15.setText(user.getSign());
